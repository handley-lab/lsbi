...
latex_documents = [
    (master_doc, 'lsbi.tex', 'lsbi Documentation',
     'Will Handley', 'manual'),
]
...
man_pages = [
    (master_doc, 'lsbi', 'lsbi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lsbi', 'lsbi Documentation',
     author, 'lsbi', 'Linear Simulation Based Inference',
     'Miscellaneous'),
]
